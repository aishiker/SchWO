#!/usr/bin/env python3
"""Run/resume the turning-aware full D_union Phase-6 V1 baseline."""
...
def main() -> int:
    ...
    try:
        return run_final_baseline_v2(
            output_root=args.output_root,
            workers=args.workers,
            resume=args.resume,
            limit=args.limit,
        )
    except (V1FinalBaselineV2Error, OSError, RuntimeError, ValueError) as exc:
        print(
            json.dumps(
                {
